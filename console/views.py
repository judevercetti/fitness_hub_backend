...
from .serializers import AttendanceSerializer, EquipmentSerializer, GymClassSerializer, MemberSerializer, MembershipPlanSerializer, PaymentSerializer, UserProfileSerializer, UserSerializer
...
class EmployeeViewSet(viewsets.ModelViewSet):
    ...
    # filter_backends = [filters.SearchFilter]
    # search_fields = ['username', 'email', 'userprofile__phone_number', 'userprofile__address', 'userprofile__position']
